...
export const tokens = {
    ...
    ARX: {
        ...
        description: 'ARX is the rewards token introduced by Arbitrum Exchange. Arbitrum Exchange is a Pancake Swap fork on the Arbitrum chain, and uses ARX to reward liquidity providers.',
        chainId: 42161,
    ...
    hrETH: {
        ...
        decimals: 18,
        website: 'https://app.hop.exchange',
        description: 'hrETH is the bridge token for transferring rETH via the Hop Protocol. Hop Protocol is a blockchain bridge protocol that allows users to move tokens from one chain to another without having to wait for a challenge period.',
        bridge: 'hop',
        documentation: 'https://docs.hop.exchange/',
        tags: ['SYNTHETIC'],
    },
    hMAGIC: {
        ...
        decimals: 18,
        website: 'https://app.hop.exchange',
        description: 'hMAGIC is the bridge token for transferring MAGIC via the Hop Protocol. Hop Protocol is a blockchain bridge protocol that allows users to move tokens from one chain to another without having to wait for a challenge period.',
        bridge: 'hop',
        documentation: 'https://docs.hop.exchange/',
    },
    hETH: {
    ...
    SLIZ: {
        ...
        description: 'SolidLizard is a decentralized exchange built on Arbitrum that offers low-cost token exchanges and reduced swap fees, using a governance model called the ve(3,3) system, which was developed by Andre Cronje and introduced in Solidly. ',
        bridge: 'native',
    ...
    RAM: {
        ...
        description: 'Ramses is a decentralized exchange built on Arbitrum that offers low-cost token exchanges and reduced swap fees, using a governance model called the ve(3,3) system, which was developed by Andre Cronje and introduced in Solidly. ',
    ...
    DPX: {
        ...
        description: 'Dopex -- A decentralized options protocol aiming to expand option liquidity throughout DeFi by minimizing option losses via rebates and maximizing reward through delegated controlled incentives',
        bridge: 'arbitrum-canonical',
    ...
    RDPX: {
        ...
        decimals: 18,
        website: 'https://www.dopex.io/',
        description: 'rDPX is the rebate token of the Dopex platform and is used to compensate option writers a portion of their losses. These rebates make losses less costly than our competitors, allowing us to drive deeper liquidity throughout the platform.',
        bridge: 'arbitrum-canonical',
    ...
    'DAI+': {
        ...
        decimals: 18,
        website: 'https://overnight.fi/',
        description: 'DAI+ is DAI that pays you yield daily via rebase. It is 100% collateralized with assets immediately convertible into USDC. Yield is generated via strategies such as lending and stable-to-stable pools. Initial strategies include Aave, Rubicon, and Pika.',
        bridge: 'native',
        documentation: 'https://docs.overnight.fi/',
        tags: ['CURATED'],
    },
    ...
    CHR: {
        ...
        description: 'Chronos is a community-owned decentralized exchange (DEX) and liquidity provider constructed on the Arbitrum Layer 2 (L2) network, aimed at fostering DeFi growth through sustainable liquidity incentives.',
    },
    wUSDR: {
        name: 'Real USD',
        symbol: 'wUSDR',
    ...
    svETH: {
        ...
        description: 'Savvy DeFi is a decentralized credit protocol on Arbitrum that grants borrowers access to an immediate advance on the future yield of their collateral in the form of Savvy synthetic tokens (svTokens). Savvy protocol allows borrowers to maintain exposure to their choice collateral while gaining access to immediate liquidity with 0% interest, no monthly payments and no risk of liquidation.',
        bridge: 'native',
    },
    svUSD: {
        name: 'Savvy USD',
    ...
    LODE: {
        ...
        description: 'Unlocking the critical DeFi primitive of decentralized money markets for Arbitrum native assets like ARB, MAGIC, GMX, and plvGLP.',
    ...
    asdCRV: {
        ...
        description: 'asdCRV represents the compounding sdCRV in the StakeDAO CRV Locker. The total amount of asdCRV contained in the compounder is equal to the total sdCRV balance multiplied by the current index',
        bridge: 'stargate',
    },
    vsdCRV: {
        ...
        description: 'The vsdCRV allows sdCRV holders to boost their voting power, thanks to the delegated veSDT. They will also benefit from vote incentives.',
        bridge: 'stargate',
    },
    crvUSD: {
    ...
    ePENDLE: {
        ...
        description: 'ePENDLE is a liquid wrapper of vePENDLE. It can be staked to earn fee/rewards generated on PENDLE.',
    ...
    fETH: {
        ...
        description: 'The fETH token, or Fractional ETH, is a decentralized, low-volatility, Ethereum-native, and “floating stablecoin”. It’s decentralized, so it avoids exposure to the shenanigans of central banks or other IRL entities. \n' +
            '\n' +
    ...
    xETH: {
        ...
        decimals: 18,
        website: 'https://fx.aladdin.club/',
        description: 'The xETH token, also called leveraged ETH, is a decentralized, composable leveraged long ETH futures contract with a low risk of liquidations and 0 funding fee (and in extreme cases, xETH minters can earn fees).',
        documentation: 'https://docs.aladdin.club/f-x-protocol',
        bridge: 'layer-zero',
    },
    stataArbUSDCn: {
    ...
    NEXT: {
        ...
        description: 'Everclear (previously Connext) is a modular protocol for securely passing funds and data between chains. Developers can use Everclear to build crosschain apps (xApps) - applications that interact with multiple domains (blockchains and/or rollups) simultaneously.',
    ...
    xGRAIL: {
        ...
        description: 'Camelot is an ecosystem-focused, community-driven DEX and Launchpad built on Arbitrum. Camelot has been built as a highly efficient and customizable protocol, allowing both builders and users to leverage our custom infrastructure for deep, sustainable, and adaptable liquidity. Camelot moves beyond the traditional design of DEXs to focus on offering a tailored approach that prioritises composability.',
        bridge: 'native',
    },
    KUJI: {
        ...
        description: 'The KUJI token is the native token on the Kujira Network. KUJI is used to pay network fees and dApp fees, and all fees collected are distributed to KUJI stakers.',
        bridge: 'axelar',
    },
    uniETH: {
        name: 'Universal ETH',
    ...
    USDx: {
        ...
        chainId: 42161,
        decimals: 18,
        website: 'https://liquidity.synthetix.eth.limo/?ref=blog.synthetix.io#/positions/USDC/1?manageAction=borrow',
    ...
    waArbUSDT: {
        ...
        decimals: 6,
        website: 'https://tether.to/',
        description: 'Wrapped Aave Staked USDT. Tether is a stablecoin pegged to the US Dollar. A stablecoin is a type of cryptocurrency whose value is pegged to another fiat currency like the US Dollar or to a commodity like Gold. Tether is the first stablecoin to be created and it is the most popular stablecoin used in the ecosystem.',
        bridge: 'native',
        documentation: 'https://tether.to/en/how-it-works',
        tags: ['STABLECOIN'],
    },
