...
export const tokens = {
    ...
    DOC: {
        ...
        description: 'Dollar on Chain (DoC) - A token that is pegged 1:1 to the US Dollar, and is crypto-collateralized in Bitcoin',
        bridge: 'native',
    ...
    RIF: {
        ...
        description: 'RIF was created to make it easier for developers to build on Bitcoin using Rootstock by proposing and developing a unified set of protocols, rules and interfaces for decentralized infrastructure services, including: Bridges, Name Resolution Services, Payments, Data Feeds (i.e. Oracles) and Bitcoin DeFi Wallets.',
        bridge: 'native',
