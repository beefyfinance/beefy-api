...
export const tokens = {
    ...
    cINU: {
        ...
        description: 'Following in the pawprints of Dogecoin and Shiba Inu, Canto Inu is the native breed token to the Canto Blockchain. It is provided solely for entertainment purposes.',
    },
    CRE8R: {
        name: 'CRE8R DAO',
        symbol: 'CRE8R',
        ...
        description: 'The world’s first & only decentralized Web3 content marketing agency DAO. Massively scalable. Fueled by DeFi.',
    },
    wstETH: {
    ...
    stATOM: {
        ...
        description: 'Using Stride’s liquid staked ATOM, you can earn both staking and DeFi yields across the Cosmos IBC ecosystem.',
    ...
    BLOTR: {
        ...
        decimals: 18,
        website: 'https://www.scanto.io/',
        description: '$BLOTR is the governance token for $sCANTO (Liquid Staked Canto) used to vote on protocol upgrades, incentivize $sCANTO liquidity pools, and for other future protocol mechanisms.',
        bridge: 'native',
    ...
    CVM: {
        ...
        description: 'CVM is the native token for Velocimeter on Canto (CVM), a project providing liquidity on the chain where it is needed most. The CVM token can be staked as or locked to earn rewards on the CVM platform.',
