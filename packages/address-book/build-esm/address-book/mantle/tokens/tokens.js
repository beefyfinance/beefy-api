const MNT = {
    ...
    description: 'With Mantle Network, an Ethereum rollup, Mantle Treasury and a token holder governed roadmap for products and initiatives.',
    bridge: 'native',
...
export const tokens = {
    ...
    USDY: {
        ...
        description: 'USDY is a tokenized note secured by short-term US Treasuries and bank demand deposits. USDY is accessible to non-US individual and institutional investors and is transferable onchain 40-50 days after purchase.',
        bridge: 'axelar',
    },
    mETH: {
    ...
    mShards: {
        ...
        description: "Ethena Shards serve as a measure of a user's contribution to the Ethena ecosystem. mShards will possibly be redeemable for Ethena's governance token ENA at some point, the ratio will be determined by Ethena.",
        bridge: 'native',
    },
    USDe: {
        name: 'USDe',
