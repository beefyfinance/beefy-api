...
export const tokens = {
    ...
    MENDI: {
        ...
        description: 'MENDI is the reward token of Mendi Finance, a lending/borrowing protocol on Linea forked from Compound V2.',
    ...
    NILE: {
        ...
        description: 'NILE is a next-gen liquidity protocol optimizing for high-frequency LPs and Layer 2 cost structures, inheriting efficiency from RAMSES on Arbitrum.',
    ...
    REX33: {
        ...
        decimals: 18,
        website: 'https://www.etherex.finance/trade',
        description: 'Liquid Staked REX. Etherex is a concentrated liquidity layer and exchange built on the Linea network, powered by the latest metaDEX x(3,3) methodology—a more fluid and accessible version of the popular ve(3,3) model.',
        documentation: 'https://docs.etherex.finance/',
        bridge: 'native',
    },
    aLinUSDC: {
    ...
    LINEA: {
        ...
        description: 'Linea is the Layer 2 network built from first principles to strengthen Ethereum and the entire ETH economy.',
