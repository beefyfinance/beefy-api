...
export const tokens = {
    ...
    TOWER: {
        ...
        description: 'The TOWER Token is an ERC-20 token native to the Ethereum blockchain designed to be a medium of exchange, utility, and governance for the Crazy Defense Heroes franchise.',
    ...
    RNBW: {
        ...
        description: 'RNBW is the native token of the Rainbow wallet. Rainbow is a fun, simple, and secure way to create an Ethereum wallet, collect NFTs, and explore the new world of Web3.',
    ...
    TEA: {
        ...
        description: 'TEA is the token of the tea Protocol, a decentralized technology framework for open-source software developers and maintainers. This Base token is the Hyperlane-bridged representation of TEA.',
