...
export const tokens = {
    ...
    MLP: {
        ...
        description: 'MLP consists of an index of assets used for swaps and leverage trading on Mummy Finance. MLP holders will make a profit when leverage traders make a loss and vice versa. Staked MLP also earns escrowed MMY rewards and 60% of platform fees distributed in ETH.',
    ...
    KNC: {
        ...
        description: 'KNC is a utility and governance token and an integral part of Kyber Network and its product KyberSwap - the multi-chain decentralized exchange (DEX) protocol that provides the best rates for traders and maximizes earnings for liquidity providers',
    ...
    UNLOCK: {
        ...
        description: 'The UNLOCK token is part of the 200 Keys NFT project ecosystem where it can be staked for rewards or used for minting and upgrading NFTs from The Forge',
    ...
    MTA: {
        ...
        description: 'Meta Vault is a composable architecture for yield-bearing tokens. It combines, optimises and allocates yield in a diversified manner.',
        bridge: 'optimism-canonical',
    ...
    EXA: {
        ...
        description: 'Exactly is a decentralized, non-custodial and open-source protocol that provides an autonomous fixed and variable interest rate market enabling users to frictionlessly exchange the time value of their assets and completing the DeFi credit market.',
    ...
    NEXT: {
        ...
        description: 'Connext is a modular protocol for securely passing funds and data between chains. Developers can use Connext to build crosschain apps (xApps) - applications that interact with multiple domains (blockchains and/or rollups) simultaneously.',
    ...
    KITE: {
        ...
        decimals: 18,
        website: 'https://www.letsgethai.com/',
        description: "KITE is the governance token for the HAI Protocol. Holders can participate in voting for system changes and have a say in the protocol's development (e.g., adding/removing collateral types).",
        documentation: 'https://docs.letsgethai.com/',
        bridge: 'native',
    },
    rsETH: {
    ...
    msOP: {
        ...
        chainId: 10,
        decimals: 18,
        description: 'msOP represents Metronome Synth OP. Through the Metronome dApp, users are able to deposit crypto assets as collateral, and use that collateral to mint popular crypto synthetics.',
        website: 'https://metronome.io/',
        documentation: 'https://docs.metronome.io/',
        bridge: 'layer-zero',
        tags: ['NO_TIMELOCK', 'SYNTHETIC'],
    ...
    waOptrETH: {
        name: 'Wrapped Optimism rETH Token',
        symbol: 'waOptrETH',
        oracleId: 'waOptrETH',
        address: '0x8e6a81b9d541A0CeA090818B62C4B2DE7f2A2Cf7',
        chainId: 10,
        decimals: 18,
        website: 'https://aave.com/',
        description: 'Aave Staked rETH token',
        bridge: 'native',
        documentation: 'https://ethereum.org/en/developers/docs/',
    },
    waOptwstETH: {
        name: 'Wrapped Optimism wstETH Token',
        symbol: 'waOptwstETH',
        oracleId: 'waOptwstETH',
        address: '0xbaF95bB30CDab3d5b7a11B67EDeF5631bD62be86',
        chainId: 10,
        decimals: 18,
        website: 'https://aave.com/',
        description: 'Aave Staked wstETH token',
        bridge: 'native',
        documentation: 'https://ethereum.org/en/developers/docs/',
    },
    waOptUSDCn: {
        name: 'Wrapped Optimism USDC Token',
        symbol: 'waOptUSDCn',
        oracleId: 'waOptUSDCn',
        ...
        decimals: 6,
        website: 'https://aave.com/',
        description: 'Aave Staked USDC token',
        bridge: 'native',
        documentation: 'https://ethereum.org/en/developers/docs/',
        tags: ['STABLECOIN'],
    },
    sfrxUSD: {
        ...
        symbol: 'sfrxUSD',
        oracleId: 'sfrxUSD', // TODO could be "FRAX" since it should be 1:1?
        website: 'https://frax.finance/',
        description: 'sfrxUSD is a replacement for FRAX on Ethereum. sfrxUSD is a crypto collateralized stablecoin pegged to the US dollar.',
        bridge: 'layer-zero',
        documentation: 'https://docs.frax.finance/',
        tags: ['STABLECOIN', 'SYNTHETIC'],
    },
