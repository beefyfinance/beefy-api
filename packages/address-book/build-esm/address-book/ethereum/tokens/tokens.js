...
export const tokens = {
    ...
    CNC: {
        ...
        description: 'Conic Finance is an easy-to-use platform built for liquidity providers to easily diversify their exposure to multiple Curve pools. Any user can provide liquidity into a Conic Omnipool which allocates funds across Curve in proportion to protocol controlled pool weights.',
        bridge: 'native',
    ...
    CTR: {
        ...
        description: 'Concentrator by Aladdin DAO maximizes Convex APYs and earns yield in the best DeFi tokens. Concentrator is a yield enhancer that boosts yields on Convex vaults by concentrating all rewards into auto-compounding top-tier tokens like aCRV (cvxCRV) and aFXS (cvxFXS/FXS).',
        bridge: 'native',
    ...
    FRAX: {
        ...
        description: 'FRAX (LFRAX, Legacy Frax) is the original stablecoin of the Frax protocol. Users can migrate 1:1 to frxUSD.',
        bridge: 'native',
    ...
    USDP: {
        ...
        description: 'Pax Dollar (USDP) is a stablecoin created by Paxos, a licenced trust firm and financial institution that ensures the backing of the tokens with US dollar deposits. With the USDP, Paxos created a token that combines the confidence and stability of fiat money with the usefulness and immediacy of digital assets.',
    },
    CRV: {
        name: 'CRV',
    ...
    CVX: {
        ...
        description: 'Convex allows Curve liquidity providers to earn trading fees and claim boosted CRV without locking CRV themselves. Liquidity providers can receive boosted CRV and liquidity mining rewards with minimal effort.',
        bridge: 'native',
    },
    cvxCRV: {
        name: 'cvxCRV',
    ...
    cvxFXS: {
        ...
        documentation: 'https://docs.convexfinance.com/',
        description: 'Convex Finance has expanded to optimize opportunities for liquidity providers on Frax the same way it has done so for Curve LPs.',
        bridge: 'native',
    },
    cvxFPIS: {
        name: 'Convex FPIS',
        ...
        website: 'https://frax.convexfinance.com/',
        documentation: 'https://docs.convexfinance.com/',
        description: "Convex also now supports Frax Finance's FPIS token, the governance token for the FPI stablecoin launched by Frax. Frax documentation explains the mechanisms behind the FPI stablecoin and the FPIS governance token in detail.",
        bridge: 'native',
    },
    cvxFXN: {
        name: 'Convex FXN',
        ...
        documentation: 'https://docs.convexfinance.com/',
        description: 'Convex Finance has extended its optimization efforts to benefit liquidity providers on FX Protocol, similar to its approach with Curve LPs.',
        bridge: 'native',
    },
    FXN: {
        name: 'FXN Token',
    ...
    aETH: {
        ...
        website: 'https://weth.io/',
        documentation: 'https://docs.aave.com/developers/v/2.0/the-core-protocol/atokens',
        description: 'Aave interest bearing DAI. Ether or ETH is the native currency built on the Ethereum blockchain.',
        bridge: 'native',
    },
    waETH: {
    ...
    UZD: {
        ...
        description: 'UZD is a rebase token that increases in value in proportion to the APY of the Zunami Protocol. It is over-collateralized by stablecoins allocated in Curve Finance pools and minted using ZLP. UZD is secure from depeg as it can be redeemed with USDT, USDC, or DAI at any time. Users can receive UZD by minting it through the Zunami interface or by swapping it in the Curve.',
    ...
    lvUSD: {
        ...
        description: 'The stablecoin lvUSD is pegged to the USD and is used for lending and repaying loans.\n' +
    ...
    VERSE: {
        ...
        description: 'At Bitcoin.com our mission is to create more economic freedom in the world. We define economic freedom as the ability to make choices with respect to one’s personal resources, unencumbered by trusted third parties or borders or lack of access. We believe economic freedom is the foundation of peace and prosperity, and by creating more of it for people, we are reducing suffering in the world. We strive to help everyone, everywhere be more economically free.',
        bridge: 'native',
    ...
    FXS: {
        ...
        decimals: 18,
        website: 'https://frax.finance/',
        description: 'FRAX (previously FXS) is the governance token of the Frax Finance protocol and the gas token of the Fraxtal chain.',
        bridge: 'native',
    },
    wBETH: {
    ...
    OETH: {
        ...
        description: 'OETH is a yield-bearing, ether-pegged token, offering an easy way to maximize yield from ETH staking using protocols, such as Curve Finance.',
        bridge: 'native',
    },
    crvUSD: {
    ...
    'ETH+': {
        ...
        bridge: 'native',
        description: 'Safety-first diversified ETH staking index with up to 4.5% APY backed by Lido Staked ETH and Rocket Pool ETH.',
    },
    dgnETH: {
        name: 'Degen ETH',
        symbol: 'dgnETH',
    ...
    'USDC+': {
        ...
        bridge: 'native',
        description: 'USDC PLUS (USDC+): A community governed yield bearing USDC index optimized for yield to holders and overcollateralization protection.',
    },
    '3CRV': {
    ...
    cvxPRISMA: {
        ...
        documentation: 'https://docs.convexfinance.com/convexfinance/general-information/convex-for-prisma-finance',
        bridge: 'native',
        description: 'Convex Finance has expanded to optimize opportunities for liquidity providers on Prisma the same way it has done so for Curve LPs.',
    },
    yPRISMA: {
        name: 'Yearn Prisma',
        symbol: 'yPRISMA',
    ...
    acUSDC: {
        ...
        decimals: 6,
        website: 'https://across.to/',
        description: "acUSDC is the LP receipt for providing USDC liquidity to the Across bridge. Across is a cross-chain bridge for L2s and rollups secured by UMA's optimistic oracle.",
        bridge: 'native',
        chainId: 1,
    ...
    acWETH: {
        ...
        decimals: 18,
        website: 'https://across.to/',
        description: "acWETH is the LP receipt for providing WETH liquidity to the Across bridge. Across is a cross-chain bridge for L2s and rollups secured by UMA's optimistic oracle.",
        bridge: 'native',
        chainId: 1,
        documentation: 'https://docs.across.to/how-to-use-across/providing-liquidity',
    },
    acDAI: {
        ...
        decimals: 18,
        website: 'https://across.to/',
        description: "acDAI is the LP receipt for providing DAI liquidity to the Across bridge. Across is a cross-chain bridge for L2s and rollups secured by UMA's optimistic oracle.",
        bridge: 'native',
        chainId: 1,
        documentation: 'https://docs.across.to/how-to-use-across/providing-liquidity',
        tags: ['SYNTHETIC'],
    ...
    acUSDT: {
        ...
        decimals: 6,
        website: 'https://across.to/',
        description: "acUSDT is the LP receipt for providing USDT liquidity to the Across bridge. Across is a cross-chain bridge for L2s and rollups secured by UMA's optimistic oracle.",
        bridge: 'native',
        chainId: 1,
        documentation: 'https://docs.across.to/how-to-use-across/providing-liquidity',
    },
    acWBTC: {
        ...
        decimals: 8,
        website: 'https://across.to/',
        description: "acWBTC is the LP receipt for providing WBTC liquidity to the Across bridge. Across is a cross-chain bridge for L2s and rollups secured by UMA's optimistic oracle.",
        bridge: 'native',
        chainId: 1,
        documentation: 'https://docs.across.to/how-to-use-across/providing-liquidity',
    },
    acACX: {
        ...
        decimals: 18,
        website: 'https://across.to/',
        description: "acACX is the LP receipt for providing ACX liquidity to the Across bridge. Across is a cross-chain bridge for L2s and rollups secured by UMA's optimistic oracle.",
        bridge: 'native',
        chainId: 1,
        documentation: 'https://docs.across.to/how-to-use-across/providing-liquidity',
    },
    ...
    ALCX: {
        ...
        website: 'https://alchemix.fi/',
        documentation: 'https://alchemix-finance.gitbook.io/user-docs/',
        description: 'Alchemix Finance is a future-yield-backed synthetic asset protocol and community DAO. The protocol gives you advances on various yield farming strategies via a synthetic token. The token represents a fungible claim on the underlying collateral in the Alchemix protocol, where the claim has to be made by a depositor of that collateral. The DAO will focus on funding projects that will help the Alchemix ecosystem grow, as well as the greater Ethereum community.',
        bridge: 'native',
    },
    RPL: {
        name: 'Rocket Pool',
        ...
        description: 'Rocket Pool is the oldest, most trusted & only decentralised staking protocol on Ethereum today.',
        bridge: 'native',
    },
    GYD: {
        name: 'Gyro Dollar',
    ...
    weETHk: {
        ...
        description: 'The King Karak LRT is intended to provide ether.fi customers an easy onboarding into the Karak ecosystem. Unlike other LRTs, users have numerous deposit options including WETH, eETH, weETH, wstETH, cbETH, bETH, rETH, mETH, swETH, etc. These assets will be directly restaked on Karak.',
    ...
    weETHs: {
        ...
        description: 'Super Symbiotic LRT is an Ether.Fi x Symbiotic vault that allows users to stake their ETH to accrue staking rewards and automatically restake their ETH in Symbiotic.',
    ...
    QIv2: {
        ...
        description: 'QiDao is an overcollateralized stablecoin protocol that allows users to mint stablecoins (MAI) against the value of their decentralized token collaterals. Minting occurs through loans, denomimated in MAI stablecoins. Most loans have 0% interest, meaning the value of the related debt does not change over time.',
    ...
    beQI: {
        ...
        decimals: 18,
        website: 'https://app.mai.finance/',
        description: 'Beefy QI is perpetually lock QI/ETH Balancer Pool Token. QiDao is an overcollateralized stablecoin protocol that allows users to mint stablecoins (MAI) against the value of their decentralized token collaterals. Minting occurs through loans, denomimated in MAI stablecoins. Most loans have 0% interest, meaning the value of the related debt does not change over time.',
        documentation: 'https://docs.mai.finance/introduction-1',
        bridge: 'native',
    },
    USDe: {
    ...
    stLINK: {
        ...
        description: 'stLINK is received by staking LINK. It is received 1:1 per each LINK staked. stLINK is a rebasing token, which means that as your LINK rewards accrue the stLINK balance in your wallet increments up, and is backed 1:1 by staked LINK owned by the stake.link protocol. stLINK can be claim or unclaimed, wrapped or unwrapped, and continues to receive rewards in any scenario.',
        bridge: 'native',
    ...
    'USD0++': {
        ...
        decimals: 18,
        website: 'https://usual.money/',
        description: 'The USD0 Liquid Bond is issued when a user decides to lock their USD0 for a specified period. In return, they receive a composable and transferable USD0++ (as a LBT), which provides rewards in the form of USUAL tokens.',
        bridge: 'native',
    ...
    RSUP: {
        ...
        decimals: 18,
        website: 'https://resupply.fi/',
        description: 'Resupply provides users with a decentralized stablecoin protocol designed to leverage liquidity and stability in lending markets. This platform enables users to supply assets, borrow reUSD, participate in governance, stake RSUP, and claim rewards.',
        documentation: 'https://docs.resupply.fi/',
    },
    fwstETH: {
