...
export const tokens = {
    ...
    TNGBL: {
        ...
        description: 'Tangible converts real world assets into tangible NFTs (TNFTs) that can be redeemed for the physical product at any time.',
        bridge: 'native',
    },
    BETS: {
        name: 'BetSwirl Token',
    ...
    RETRO: {
        ...
        description: 'Retro is more than just a decentralized exchange and automated market maker. We are a solution for protocols on Polygon to incentivize liquidity and earn revenue. For users, we provide a mix of tried-and-true as well as innovative ve(3,3) tokenomics to bring them greater yields and liquidity.  Our structure and commitment to maximizing gains for all users will continue to drive us to make changes and improvements to the ve(3,3) model.',
    ...
    LUCHA: {
        ...
        description: 'Luchadores.io is a 100% on-chain auto-battler in an 8-bit style for the nostalgic retro gamer and the universe of Lucha Libre!',
        bridge: 'native',
