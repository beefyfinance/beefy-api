...
export const tokens = {
  ...
  PAIR: {
    ...
    description:
      'PAIR is a community token launched through PAIR, a permissionless Robinhood Chain launchpad that lets users create fixed-supply tokens and pair them with tokenized stocks or other supported assets in permanently locked Uniswap V4 liquidity markets.',
  ...
  rhINDEX: {
    ...
    description:
      "The Index Finance is a stock dividend protocol designed for Robinhood Chain's tokenized stocks. Holders of the Index token earn stocks purchased using the fees generated by Index's liquidity pools.",
  ...
  PARE: {
    ...
    description:
      "PARE is the protocol token of parestocks.com on Robinhood Chain, issued for the tokenized-stock splitting ecosystem. The token supports the Pare protocol's buyback-and-burn, future listing governance and holder fee discounts.",
  ...
  DELTA: {
    ...
    description:
      'DELTA is the protocol token of Delta Liquidity, a Robinhood Chain liquidity protocol focused on staking and compounding liquidity-pool positions.',
  ...
  NET: {
    ...
    description:
      'NET is a reserve-backed, staking/rebasing ERC-20 issued by NetNet Capital on Robinhood Chain, designed as an OlympusDAO v1-inspired reserve instrument backed by USDG.',
  ...
  BABArh: {
    ...
    website: 'https://robinhood.com/rhj/stocktokens/',
    description:
      'Alibaba • Robinhood Token is a tokenized debt security issued by Robinhood Assets (Jersey) Limited that provides price exposure to Alibaba Group shares without conferring ownership or shareholder rights.',
    documentation: 'https://docs.robinhood.com/chain/stock-tokens/',
    bridge: 'native',
    tags: ['STOCK'],
  },
  SGOVrh: {
    ...
    website: 'https://robinhood.com/rhj/stocktokens/',
    description:
      'iShares 0-3 Month Treasury Bond • Robinhood Token is a tokenized debt security issued by Robinhood Assets (Jersey) Limited that provides price exposure to iShares 0-3 Month Treasury Bond without conferring ownership or shareholder rights.',
    documentation: 'https://docs.robinhood.com/chain/stock-tokens/',
    bridge: 'native',
    tags: ['STOCK'],
  },
  PFErh: {
    ...
    website: 'https://robinhood.com/rhj/stocktokens/',
    description:
      'Pfizer • Robinhood Token is a tokenized debt security issued by Robinhood Assets (Jersey) Limited that provides price exposure to Pfizer shares without conferring ownership or shareholder rights.',
    documentation: 'https://docs.robinhood.com/chain/stock-tokens/',
    bridge: 'native',
    tags: ['STOCK'],
  },
  LLYrh: {
    ...
    website: 'https://robinhood.com/rhj/stocktokens/',
    description:
      'Eli Lilly • Robinhood Token is a tokenized debt security issued by Robinhood Assets (Jersey) Limited that provides price exposure to Eli Lilly shares without conferring ownership or shareholder rights.',
    documentation: 'https://docs.robinhood.com/chain/stock-tokens/',
    bridge: 'native',
    tags: ['STOCK'],
  },
  JNJrh: {
    ...
    website: 'https://robinhood.com/rhj/stocktokens/',
    description:
      'Johnson & Johnson • Robinhood Token is a tokenized debt security issued by Robinhood Assets (Jersey) Limited that provides price exposure to Johnson & Johnson shares without conferring ownership or shareholder rights.',
    documentation: 'https://docs.robinhood.com/chain/stock-tokens/',
    bridge: 'native',
    tags: ['STOCK'],
  },
