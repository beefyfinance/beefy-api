...
const xDAI = {
    ...
    description: 'xDai is the native currency built on the Gnosis blockchain, it is generated when a Dai is sent to the xDai bridge, the bridge validators mint the xDai as part of the Gnosis reward native contract.',
...
exports.tokens = {
    ...
    COW: {
        ...
        bridge: 'gnosis-canonical',
        description: 'CoW Protocol finds the lowest price for your trade across all exchanges and aggregators, such as Uniswap and 1inch – and protects you from MEV, unlike the others.',
    },
    crvUSD: {
    ...
    USDCe: {
        ...
        description: 'USDC.e on the Gnosis Chain follows the Circle standard. Issued by regulated financial institutions, it is backed by fully reserved assets and is redeemable on a 1:1 basis for US dollars. This version facilitates future bridging via Circle’s Cross-Chain Transfer Protocol (CCTP).',
