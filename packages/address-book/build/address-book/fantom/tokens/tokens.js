...
exports.tokens = {
    ...
    binSPIRIT: {
        ...
        documentation: 'https://docs.beefy.finance/beefy-products/beefy-escrowed-tokens/binspirit#what-is-binspirit',
    },
    CREDIT: {
        name: 'Creditum',
        symbol: 'CREDIT',
    ...
    MLP: {
        ...
        bridge: 'native',
        description: 'MLP consists of an index of assets used for swaps and leverage trading on Mummy Finance. MLP holders will make a profit when leverage traders make a loss and vice versa. Staked MLP also earns escrowed MMY rewards and 60% of platform fees distributed in FTM.',
    ...
    lzWETH: {
        ...
        website: 'https://ethereum.org/',
        bridge: 'layer-zero',
        description: 'Wrapped Ethereum (wETH) is a tokenized version of Ether that is compatible with the ERC-20 standard, which allows it to be used in decentralized applications and traded on decentralized exchanges, providing greater liquidity and interoperability for the Ethereum ecosystem.',
        documentation: 'https://layerzero.gitbook.io/docs/',
    },
    lzWBTC: {
        name: 'Wrapped BTC',
        ...
        website: 'https://wbtc.network/',
        bridge: 'layer-zero',
        description: 'Wrapped Bitcoin (WBTC) is an ERC20 token backed 1:1 with Bitcoin, which brings greater liquidity to the Ethereum ecosystem including decentralized exchanges and financial applications. It allows Bitcoin holders to use their Bitcoin on the Ethereum network and participate in the DeFi ecosystem.',
        documentation: 'https://layerzero.gitbook.io/docs/',
    },
    frxETH: {
        name: 'Frax Ether',
    ...
    axlETH: {
        ...
        bridge: 'axelar',
        description: 'Axelar Wrapped ETH (axlETH) is an ERC-20 token that represents a wrapped version of native Ethereum (ETH) cryptocurrency, allowing for cross-chain transfers and compatibility with the Ethereum ecosystem.',
    ...
    FVM: {
        ...
        bridge: 'native',
        description: 'FVM is the native token for Velocimeter on Fantom (FVM), a project providing liquidity on the chain where it is needed most. The FVM token can be staked as or locked to earn rewards on the FVM platform.',
    ...
    fUSDCe: {
        ...
        description: "USDC.e is a bridged, USDC-backed token on the Fantom network through Wormhole's interoperability infrastructure. This implementation consolidates USDC liquidity on Fantom, setting a pathway for potential evolution into a native USDC stablecoin, enhancing ecosystem utility and developer engagement.",
        chainId: 250,
        bridge: 'wormhole',
        tags: ['STABLECOIN', 'SYNTHETIC'],
    },
