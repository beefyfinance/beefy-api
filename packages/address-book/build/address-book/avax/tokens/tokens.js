...
exports.tokens = {
    ...
    COQ: {
        ...
        description: 'Coq Inu is a vibrant memecoin deeply rooted in community, humor, and memetics within the Avalanche ecosystem. It offers a range of community-driven projects and engagements, emphasizing fun and togetherness as a way of life.',
        bridge: 'native',
    },
    GEC: {
        ...
        description: "Gecko Inu is a community-driven memecoin at the core of AVAX's ecosystem, emphasizing friendship and enjoyment. Explore the dynamic web3.0 landscape alongside Gecko Inu, engaging in a spirited, laughter-filled adventure that celebrates togetherness within the Avalanche community.",
        bridge: 'native',
    },
    NOCHILL: {
        ...
        description: 'A memecoin on AVAX focused on the topic of AVAX having NO CHILL. Born out of the StarsArena community.',
    ...
    KIMBO: {
        ...
        description: 'KIMBO is positioned as a standout token on AVAX, backed by a strong community of AVAX pioneers, aiming to dominate the crypto space. It aspires to lead in culture and meme creation on the AVAX network, supporting a broader strategy to enhance creator culture within the AVAX ecosystem.',
        bridge: 'native',
    },
    EURC: {
        name: 'Euro Coin',
    ...
    SNEK: {
        ...
        description: 'SoliSnek is a revolutionary decentralized exchange and automatic market maker that has been built upon the original Solidly vision, and has now been brought to the Avalanche blockchain.',
    ...
    DOLA: {
        ...
        description: 'DOLA is a synthetic stablecoin pegged to the US Dollar. It is designed to be valued as close to $1 as possible with minimal volatility. DOLA is debt-backed rather than algorithmic, meaning that DOLA is backed by retractable debt.',
        bridge: 'multichain',
    ...
    aavAVAX: {
        ...
        description: 'Aave interest bearing AVAX. Avalanche is the fastest smart contracts platform in the blockchain industry, as measured by time-to-finality, and has the most validators securing its activity of any proof-of-stake protocol.',
        bridge: 'native',
    },
    waavAVAX: {
        ...
        website: 'https://aave.com',
        documentation: 'https://docs.aave.com/developers/v/2.0/the-core-protocol/atokens',
        description: 'Wrapped Aave interest bearing AVAX. Avalanche is the fastest smart contracts platform in the blockchain industry, as measured by time-to-finality, and has the most validators securing its activity of any proof-of-stake protocol.',
        bridge: 'native',
    },
    bbaavAVAX: {
    ...
    bbaavUSD: {
        ...
        website: 'https://app.balancer.fi/#/',
        documentation: 'https://docs.balancer.fi/products/balancer-pools/boosted-pools',
        description: 'Balancer composable pool that consist of bbaUSDT and bbaUSDC. bbTokens are Aave boosted linear pools.',
        bridge: 'native',
    },
    ZRO: {
        name: 'LayerZero',
    ...
    ggAVAX: {
        ...
        description: 'Through liquid staking, GoGoPool allows users to stake their AVAX and earn returns without locking up their assets. They receive ggAVAX, which they can trade anytime, providing flexibility along with earning potential.',
        bridge: 'native',
    },
    waAvaWAVAX: {
        chainId: 43114,
    ...
    rsAVAX: {
        ...
        chainId: 43114,
        decimals: 18,
        website: 'https://yieldyak.com/avalanche/milk/0xDf788AD40181894dA035B827cDF55C523bf52F67/',
