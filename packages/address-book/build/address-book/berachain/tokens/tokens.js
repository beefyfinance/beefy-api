...
exports.tokens = {
    ...
    BGT: {
        ...
        decimals: 18,
        website: 'https://www.berachain.com/',
        description: '$BGT is earned by performing certain actions in dApps with whitelisted Reward Vaults. Most of the time, this is related to providing liquidity, but it is not limited to this. Reward Vault deposits correspond to some form of productive activity on Berachain.',
    ...
    iBGT: {
        ...
        description: 'Infrared’s iBGT, a liquid version of Berachain’s Governance Token (BGT), helps you maximize Proof of Liquidity (PoL) rewards.',
    ...
    iBERA: {
        ...
        description: 'iBERA is Infrared’s liquid staking solution that makes staking BERA tokens accessible to everyone.',
    ...
    NAV: {
        ...
        description: 'NAV Finance is a regulated on-chain hedge fund offering Structured Investment Products (SIPs) designed for high-growth opportunities in DeFi.',
        bridge: 'native',
    },
    bm: {
        name: 'bm',
    ...
    BREAD: {
        ...
        description: 'BakerDAO combines token economics, collateralized lending, leverage, and Proof-of-Liquidity into a single cohesive financial ecosystem. The $BREAD token features a mathematically-enforced upward price trajectory, backed by $BERA tokens.',
        bridge: 'native',
    },
    OOGA: {
        name: 'OOGA',
