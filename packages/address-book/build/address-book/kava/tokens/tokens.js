...
exports.tokens = {
    ...
    VARA: {
        ...
        description: 'Équilibre is an ve(3.3) AMM (Automatic Market Maker) based on Velodrome, and designed to provide large liquidity & low swapping fees.',
        bridge: 'native',
    },
    oldBIFI: {
        name: 'Beefy.Finance',
    ...
    MARE: {
        ...
        description: 'Mare Finance is an EVM compatible lending/borrowing protocol that launched on Kava EVM. Mare Finance provides peer-to-peer lending solutions that are fully decentralized, transparent and non-custodial.',
    ...
    axlWBTC: {
        ...
        decimals: 8,
        website: 'https://axelar.network/',
        description: "Axelar Wrapped WBTC (axlWBTC) is an ERC-20 token that represents a 1:1 pegged version of Bitcoin, allowing users to access Bitcoin's value and liquidity within the Kava ecosystem.",
        documentation: 'https://docs.axelar.dev/resources/wrapped-tokens',
        bridge: 'axelar',
    },
    ATOM: {
    ...
    lzETH: {
        ...
        description: 'LayerZero Wrapped ETH (lzETH) is an ERC-20 token that represents a wrapped version of native Ethereum (ETH) cryptocurrency, allowing for cross-chain transfers and compatibility with the Ethereum ecosystem.',
        bridge: 'layer-zero',
    },
    lzWBTC: {
        ...
        decimals: 8,
        website: 'https://layerzero.network/',
        description: "LayerZero Wrapped WBTC (lzWBTC) is an ERC-20 token that represents a 1:1 pegged version of Bitcoin, allowing users to access Bitcoin's value and liquidity within the Kava ecosystem.",
        bridge: 'layer-zero',
    },
};
