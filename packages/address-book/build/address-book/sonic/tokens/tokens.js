...
exports.tokens = {
    ...
    EQUAL: {
        ...
        description: 'Equalizer Exchange is the fastest liquidity hub providing optimized trading and earning opportunities.',
        documentation: '',
        bridge: 'native',
    },
    USDCe: {
    ...
    stS: {
        ...
        description: 'stS is a liquid-staked token that users receive when they stake $S on the Beets platform. The value of stS naturally appreciates in relation to $S thanks to native network staking rewards from validator delegation being automatically compounded within the token.',
    ...
    OS: {
        ...
        description: 'Origin Sonic (OS) is a liquid staking token on the Sonic network designed to offer enhanced security, higher yield, and a tighter peg to S when compared to other Sonic LSTs. ',
    ...
    BRUSH: {
        ...
        description: 'PaintSwap is a decentralized finance powerhouse, combining an open NFT marketplace with a dedicated financial NFT marketplace.',
    ...
    'bUSDCe-20': {
        ...
        description: 'Silo Finance borrowable USDC.e deposit token, reflecting USDC.e deposited into Silo. Deposit tokens are issued at a ratio of 1,000 tokens per dollar deposited (or $0.001 per dollar deposited).',
    ...
    beS: {
        ...
        description: 'Beefy-escrowed Sonic (beS) is a liquid staking derivative of Sonic (S). It automatically stakes a user’s wS tokens to earn staking rewards. Each beS token represents a proportional share of the staked wS, including any rewards accrued over time. Users can convert beS back to wS with a 14-day unbonding period, or freely trade beS on the open market.',
    ...
    FIVE: {
        ...
        description: 'DeFive, previously known as WigoSwap on Fantom (with over $1 billion in transaction volume), is a redefined and progressive DeFi platform built on Sonic.',
    ...
    beGEMS1: {
        ...
        description: 'beGEMS are a liquid ERC-20 token issued by Beefy that represent its share of Sonic Gems airdrop rewards, earned by users through boosting vaults, providing liquidity, or voting for beS pairs across Sonic exchanges.',
