...
const getAuroraSwapApys = require('./getAuroraSwapApys');
...
const getApys = [getTrisolarisApys, getAuroraBifiGovApy, getTriMinichefApys, getAuroraSwapApys, getSolaceApy, getAuroraBifiMaxiApy];
