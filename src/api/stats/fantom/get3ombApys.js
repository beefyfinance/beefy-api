...
const pools = require('../../../data/fantom/3ombLpPools.json');
...
const rewardPool = '0x1040085D268253e8D4f932399a8019f527e58d04';
const oracleId = '3SHARES';
const oracle = 'tokens';
const DECIMALS = '1e18';

const get3ombApys = async () => {
  let promises = [];
