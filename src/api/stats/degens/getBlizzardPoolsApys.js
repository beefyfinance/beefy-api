...
const pools = require('../../../data/degens/blizzardPools.json');
...
const getBlizzardPoolsApys = async () => {
  let apys = {};
...
const getPoolApy = async (masterchef, pool) => {
  const [yearlyRewardsInUsd, totalStakedInUsd] = await Promise.all([
    ...
    getTotalStakedInUsd(masterchef, pool.address, pool.oracle, pool.oracleId),
  ]);
...
module.exports = getBlizzardPoolsApys;
