...
const ROLLUX_RPC = process.env.ROLLUX_RPC || 'https://rpc.rollux.com';
...
const ROLLUX_CHAIN_ID = ChainId.rollux;
...
const ROLLUX_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/beefyfinance/beefy-v2/prod/src/config/vault/rollux.json';
