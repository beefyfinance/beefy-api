const Silo = [
  {
    inputs: [
      { internalType: 'contract ISiloRepository', name: '_repository', type: 'address' },
  ...
  { inputs: [], name: 'ZeroShares', type: 'error' },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: 'enum IBaseSilo.AssetStatus', name: 'status', type: 'uint8' },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'amount', type: 'uint256' },
      { indexed: false, internalType: 'bool', name: 'collateralOnly', type: 'bool' },
    ],
    name: 'Deposit',
    type: 'event',
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: 'address', name: 'asset', type: 'address' },
      { indexed: true, internalType: 'address', name: 'user', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'shareAmountRepaid', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'seizedCollateral', type: 'uint256' },
    ],
    name: 'Liquidate',
    type: 'event',
  },
  ...
  },
  {
    ...
    outputs: [
      {
        components: [
          { internalType: 'contract IShareToken', name: 'collateralToken', type: 'address' },
          { internalType: 'contract IShareToken', name: 'collateralOnlyToken', type: 'address' },
          { internalType: 'contract IShareToken', name: 'debtToken', type: 'address' },
          { internalType: 'uint256', name: 'totalDeposits', type: 'uint256' },
          { internalType: 'uint256', name: 'collateralOnlyDeposits', type: 'uint256' },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256[][]', name: 'receivedCollaterals', type: 'uint256[][]' },
      { internalType: 'uint256[][]', name: 'shareAmountsToRepay', type: 'uint256[][]' },
    ],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  },
  {
    ...
    outputs: [{ internalType: 'uint256[]', name: 'harvestedAmounts', type: 'uint256[]' }],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      {
        components: [
          { internalType: 'uint256', name: 'harvestedProtocolFees', type: 'uint256' },
          { internalType: 'uint256', name: 'protocolFees', type: 'uint256' },
          { internalType: 'uint64', name: 'interestRateTimestamp', type: 'uint64' },
          { internalType: 'enum IBaseSilo.AssetStatus', name: 'status', type: 'uint8' },
        ],
