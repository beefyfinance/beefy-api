const SteakHouse = [
  {
    inputs: [
      { internalType: 'contract IERC20[]', name: '_RewardTokens', type: 'address[]' },
    ...
    outputs: [
      {
        ...
        internalType: 'struct SteakHouseV2.PoolInfo',
        name: '',
        type: 'tuple',
      },
    ],
  ...
  {
    inputs: [{ internalType: 'address', name: '_depositFeeReceiver', type: 'address' }],
    name: 'setDepositFeeReceiver',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  {
    inputs: [{ internalType: 'address', name: '_harvestFeeReceiver', type: 'address' }],
  ...
  {
    inputs: [{ internalType: 'contract IERC20[]', name: '_RewardTokens', type: 'address[]' }],
  ...
  },
  {
    inputs: [
      { internalType: 'uint256', name: '_rewardsPerSecond', type: 'uint256' },
      { internalType: 'uint16', name: '_rid', type: 'uint16' },
      { internalType: 'bool', name: '_withUpdate', type: 'bool' },
    ],
