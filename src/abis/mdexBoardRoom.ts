const mdexBoardRoom = [
  {
    inputs: [
      { internalType: 'contract IWBNB', name: '_wbnb', type: 'address' },
  ...
  {
    inputs: [{ internalType: 'address', name: '_bad', type: 'address' }],
    name: 'addBadAddress',
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_wbnbAmount', type: 'uint256' },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'accWBNBPerShare', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
