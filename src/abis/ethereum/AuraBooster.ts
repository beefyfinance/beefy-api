const AuraBooster = [
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'address', name: 'newArbitrator', type: 'address' }],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'address', name: 'rewardFactory', type: 'address' },
      { indexed: false, internalType: 'address', name: 'stashFactory', type: 'address' },
      { indexed: false, internalType: 'address', name: 'tokenFactory', type: 'address' },
    ],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'address', name: 'feeDistro', type: 'address' },
  ...
  },
  {
    ...
    inputs: [
      { indexed: false, internalType: 'address', name: 'feeDistro', type: 'address' },
      { indexed: false, internalType: 'address', name: 'lockFees', type: 'address' },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'address', name: 'newFeeManager', type: 'address' }],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'uint256', name: 'lockIncentive', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'stakerIncentive', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'earmarkIncentive', type: 'uint256' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'address', name: 'stash', type: 'address' },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'address', name: 'newPoolManager', type: 'address' }],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'address', name: 'lockRewards', type: 'address' },
      { indexed: false, internalType: 'address', name: 'stakerRewards', type: 'address' },
    ],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'address', name: 'newVoteDelegate', type: 'address' }],
