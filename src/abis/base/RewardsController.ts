const RewardsController = [
  { inputs: [], stateMutability: 'nonpayable', type: 'constructor' },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: 'address', name: 'emissionToken', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'totalAccrued', type: 'uint256' },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'address', name: 'emissionToken', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'newIndex', type: 'uint256' },
      { indexed: false, internalType: 'uint32', name: 'newTimestamp', type: 'uint32' },
    ],
  ...
  },
  {
    ...
    inputs: [
      { indexed: false, internalType: 'contract MToken', name: 'mToken', type: 'address' },
      { indexed: false, internalType: 'address', name: 'emissionToken', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'newSupplyIndex', type: 'uint256' },
      { indexed: false, internalType: 'uint32', name: 'newSupplyGlobalTimestamp', type: 'uint32' },
    ],
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: 'contract MToken', name: 'mToken', type: 'address' },
      { indexed: true, internalType: 'address', name: 'emissionToken', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'oldRewardSpeed', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'newRewardSpeed', type: 'uint256' },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: 'address', name: 'emissionToken', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'supplySpeed', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'borrowSpeed', type: 'uint256' },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'uint256', name: 'oldEmissionCap', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'newEmissionCap', type: 'uint256' },
    ],
    name: 'NewEmissionCap',
    type: 'event',
  },
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: 'contract MToken', name: 'mToken', type: 'address' },
      { indexed: true, internalType: 'address', name: 'emissionToken', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'currentEndTime', type: 'uint256' },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_supplyEmissionPerSec', type: 'uint256' },
      { internalType: 'uint256', name: '_borrowEmissionsPerSec', type: 'uint256' },
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: 'uint224', name: 'supplyGlobalIndex', type: 'uint224' },
          { internalType: 'uint32', name: 'supplyGlobalTimestamp', type: 'uint32' },
          { internalType: 'uint224', name: 'borrowGlobalIndex', type: 'uint224' },
          { internalType: 'uint32', name: 'borrowGlobalTimestamp', type: 'uint32' },
          { internalType: 'uint256', name: 'supplyEmissionsPerSec', type: 'uint256' },
          { internalType: 'uint256', name: 'borrowEmissionsPerSec', type: 'uint256' },
        ],
