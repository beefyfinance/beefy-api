const SwapAbi = [
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'lpTokenSupply', type: 'uint256' },
    ],
    name: 'AddLiquidity',
    type: 'event',
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint8', name: 'tokenIndex', type: 'uint8' },
      { indexed: false, internalType: 'uint256', name: 'amount', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'amountFee', type: 'uint256' },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint256', name: 'newAdminFee', type: 'uint256' }],
    name: 'NewAdminFee',
    type: 'event',
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint256', name: 'newSwapFee', type: 'uint256' }],
    name: 'NewSwapFee',
    type: 'event',
  },
  {
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: 'address', name: 'provider', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'lpTokenAmount', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'lpTokenSupply', type: 'uint256' },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'uint256', name: 'currentA', type: 'uint256' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'tokensBought', type: 'uint256' },
      { indexed: false, internalType: 'uint128', name: 'soldId', type: 'uint128' },
      { indexed: false, internalType: 'uint128', name: 'boughtId', type: 'uint128' },
    ],
    name: 'TokenSwap',
    type: 'event',
  },
  ...
  },
  {
    ...
    outputs: [{ internalType: 'uint256', name: 'availableTokenAmount', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [
      { internalType: 'contract IERC20[]', name: '_pooledTokens', type: 'address[]' },
      ...
      { internalType: 'address', name: 'lpTokenTargetAddress', type: 'address' },
    ],
    name: 'initialize',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'newProtocolFeeShareBPS', type: 'uint256' },
    ],
