const PangolinChef = [
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'address', name: 'migrator', type: 'address' }],
    name: 'MigratorSet',
    type: 'event',
  },
  {
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'contract IERC20[]', name: '_lpTokens', type: 'address[]' },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'contract IRewarder[]', name: 'rewarders', type: 'address[]' },
