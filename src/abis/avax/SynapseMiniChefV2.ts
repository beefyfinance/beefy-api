const SynapseMiniChefV2 = [
  {
    inputs: [{ internalType: 'contract IERC20', name: '_synapse', type: 'address' }],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'uint256', name: 'synapsePerSecond', type: 'uint256' },
    ],
  ...
  },
  {
    ...
    name: 'poolInfo',
    outputs: [
      { internalType: 'uint128', name: 'accSynapsePerShare', type: 'uint128' },
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_synapsePerSecond', type: 'uint256' }],
...
export default SynapseMiniChefV2;
