const LydChef = [
  {
    ...
    inputs: [
      { type: 'address', name: '_lyd', internalType: 'contract LydToken' },
      { type: 'address', name: '_electrum', internalType: 'contract ElectrumBar' },
      { type: 'address', name: '_devaddr', internalType: 'address' },
      { type: 'uint256', name: '_lydPerSec', internalType: 'uint256' },
  ...
  },
  {
    ...
    inputs: [
      { type: 'address', name: 'user', internalType: 'address', indexed: true },
      { type: 'uint256', name: '_lydPerSec', internalType: 'uint256', indexed: false },
    ],
    anonymous: false,
  },
  {
  ...
  },
  {
    type: 'function',
    stateMutability: 'view',
    outputs: [{ type: 'address', name: '', internalType: 'contract ElectrumBar' }],
    name: 'electrum',
    inputs: [],
  },
  {
  ...
  },
  {
    type: 'function',
    stateMutability: 'view',
    outputs: [{ type: 'address', name: '', internalType: 'contract LydToken' }],
    name: 'lyd',
    inputs: [],
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      { type: 'uint256', name: 'accLydPerShare', internalType: 'uint256' },
    ],
    name: 'poolInfo',
  ...
  },
  {
    ...
    outputs: [],
    name: 'updateEmissionRate',
    inputs: [{ type: 'uint256', name: '_lydPerSec', internalType: 'uint256' }],
  },
  {
    type: 'function',
    stateMutability: 'nonpayable',
