const JoeChef = [
  {
    ...
    inputs: [
      { type: 'address', name: '_joe', internalType: 'contract JoeToken' },
      { type: 'address', name: '_devAddr', internalType: 'address' },
      { type: 'address', name: '_treasuryAddr', internalType: 'address' },
      { type: 'address', name: '_investorAddr', internalType: 'address' },
      { type: 'uint256', name: '_joePerSec', internalType: 'uint256' },
      { type: 'uint256', name: '_startTimestamp', internalType: 'uint256' },
      { type: 'uint256', name: '_devPercent', internalType: 'uint256' },
      { type: 'uint256', name: '_treasuryPercent', internalType: 'uint256' },
      { type: 'uint256', name: '_investorPercent', internalType: 'uint256' },
    ],
  },
  {
    type: 'event',
  ...
  },
  {
    ...
    inputs: [
      { type: 'address', name: 'user', internalType: 'address', indexed: true },
      { type: 'uint256', name: '_joePerSec', internalType: 'uint256', indexed: false },
    ],
    anonymous: false,
  },
  {
    ...
    inputs: [
      ...
      { type: 'uint256', name: 'accJoePerShare', internalType: 'uint256', indexed: false },
    ],
    anonymous: false,
  },
  {
  ...
  },
  {
    type: 'function',
    stateMutability: 'view',
    outputs: [{ type: 'address', name: '', internalType: 'contract JoeToken' }],
    name: 'joe',
    inputs: [],
  },
  {
  ...
  },
  {
    ...
    stateMutability: 'view',
    outputs: [
      { type: 'uint256', name: 'pendingJoe', internalType: 'uint256' },
  ...
  },
  {
    ...
    inputs: [{ type: 'address', name: '_treasuryAddr', internalType: 'address' }],
  },
  {
    type: 'function',
    stateMutability: 'nonpayable',
    ...
    inputs: [{ type: 'uint256', name: '_newTreasuryPercent', internalType: 'uint256' }],
  },
  {
    type: 'function',
    stateMutability: 'view',
  ...
  },
  {
    ...
    outputs: [],
    name: 'updateEmissionRate',
    inputs: [{ type: 'uint256', name: '_joePerSec', internalType: 'uint256' }],
  },
  {
    type: 'function',
    stateMutability: 'nonpayable',
