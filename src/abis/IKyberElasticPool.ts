const IKyberElasticPoolAbi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'qty0', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'qty1', type: 'uint256' },
    ],
    name: 'Burn',
    type: 'event',
  },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'uint160', name: 'sqrtP', type: 'uint160' },
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: 'address', name: 'sender', type: 'address' },
      { indexed: true, internalType: 'address', name: 'recipient', type: 'address' },
      { indexed: false, internalType: 'int256', name: 'deltaQty0', type: 'int256' },
      { indexed: false, internalType: 'int256', name: 'deltaQty1', type: 'int256' },
      { indexed: false, internalType: 'uint160', name: 'sqrtP', type: 'uint160' },
      { indexed: false, internalType: 'uint128', name: 'liquidity', type: 'uint128' },
      { indexed: false, internalType: 'int24', name: 'currentTick', type: 'int24' },
    ],
    name: 'Swap',
    type: 'event',
  },
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'uint128', name: 'secondsPerLiquidityGlobal', type: 'uint128' },
  ...
  },
  {
    ...
    outputs: [{ internalType: 'uint128', name: 'secondsPerLiquidityInside', type: 'uint128' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint128', name: 'secondsPerLiquidityOutside', type: 'uint128' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
