const StratUniV3 = [
  {
    inputs: [
      ...
      { internalType: 'contract INftManager', name: '_nftManager', type: 'address' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'ppfs', type: 'uint256' },
    ],
    name: 'StratHarvest',
    type: 'event',
  },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'bool', name: 'upkeepRebalance', type: 'bool' },
      { indexed: false, internalType: 'uint32', name: 'twapDuration', type: 'uint32' },
      { indexed: false, internalType: 'int24', name: 'tickRangeMultiplier', type: 'int24' },
      { indexed: false, internalType: 'int24', name: 'safeDeviation', type: 'int24' },
      { indexed: false, internalType: 'int24', name: 'tickSway', type: 'int24' },
    ],
    name: 'UpdateParams',
    type: 'event',
  },
