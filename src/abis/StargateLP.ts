const StargateLPAbi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'amountSD', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'idealBalance', type: 'uint256' },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'swapDeltaBP', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'lpDeltaBP', type: 'uint256' },
      { indexed: false, internalType: 'bool', name: 'defaultSwapMode', type: 'bool' },
      { indexed: false, internalType: 'bool', name: 'defaultLPMode', type: 'bool' },
    ],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'address', name: 'feeLibraryAddr', type: 'address' }],
    name: 'FeeLibraryUpdated',
    type: 'event',
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint256', name: 'mintFeeBP', type: 'uint256' }],
    name: 'FeesUpdated',
    type: 'event',
  },
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'amountLP', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'amountSD', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'mintFeeAmountSD', type: 'uint256' },
    ],
    name: 'Mint',
    type: 'event',
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: '_amountSD', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: '_amountToMintSD', type: 'uint256' },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'address', name: 'from', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'amountSD', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'eqReward', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'eqFee', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'protocolFee', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'lpFee', type: 'uint256' },
    ],
    name: 'Swap',
    type: 'event',
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'amountSD', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'protocolFee', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'dstFee', type: 'uint256' },
    ],
    name: 'SwapRemote',
    type: 'event',
  },
