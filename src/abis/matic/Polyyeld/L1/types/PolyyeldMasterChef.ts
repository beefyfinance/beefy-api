...
export type ContractContext = Web3ContractContext<
  ...
  PolyyeldMasterChefEventsContext,
  PolyyeldMasterChefEvents
>;
export type PolyyeldMasterChefEvents =
  | 'Deposit'
  | 'EmergencyWithdraw'
  ...
  | 'UpdateEmissionRate'
  | 'Withdraw';
export interface PolyyeldMasterChefEventsContext {
  Deposit(
    parameters: {
...
export type PolyyeldMasterChefMethodNames =
  | 'new'
...
export interface PolyyeldMasterChef {
  /**
   * Payable: false
   * Constant: false
   ...
   * Type: function
   */
  YeldPerBlock(): MethodConstantReturnContext<string>;
  /**
   * Payable: false
   * Constant: false
   * StateMutability: nonpayable
   ...
   * StateMutability: nonpayable
   * Type: function
   * @param _YeldPerBlock Type: uint256, Indexed: false
   */
  updateEmissionRate(_YeldPerBlock: string): MethodReturnContext;
  /**
   * Payable: false
   * Constant: false
   * StateMutability: nonpayable
