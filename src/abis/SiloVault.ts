const SiloVault = [
  {
    inputs: [
      ...
      {
        internalType: 'contract IVaultIncentivesModule',
        name: '_vaultIncentivesModule',
        type: 'address',
      },
      {
        internalType: 'address',
  ...
  },
  {
    ...
    name: 'InternalSupplyCapExceeded',
    type: 'error',
  },
  {
    inputs: [
  ...
  },
  {
    ...
    name: 'setArbitraryLossThreshold',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
